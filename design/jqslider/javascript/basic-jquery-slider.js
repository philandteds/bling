    ...
    $.fn.bjqs = function (options) {
        ...
        if (settings.showControls && slideCount > 1) {
            ...
            var $controlContainer = $('<ul class="bjqs-controls"></ul>'),
                $next = $('<li><a href="javascript:void(0)" class="bjqs-next" class="controls">' + settings.nextText + '</a></li>'),
                $previous = $('<li><a href="javascript:void(0)" class="bjqs-prev" class="controls">' + settings.prevText + '</a></li>');
            ...
            $.each(slides, function (key, value) {
                if (settings.animType === 'slide') {
                    if (key !== 0 && key !== slideCount - 1) {
                        $marker = $('<li><a href="javascript:void(0)">' + key + '</a></li>');
                    }
                } else {
                    key++;
                    $marker = $('<li><a href="javascript:void(0)">' + key + '</a></li>');
